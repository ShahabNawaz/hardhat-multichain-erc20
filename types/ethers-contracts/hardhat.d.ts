...
getContractFactory(name: 'TokenCaller', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.TokenCaller__factory>

  getContractAt(name: 'MyToken', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.MyToken>
getContractAt(name: 'TokenCaller', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.TokenCaller>

  deployContract(name: 'MyToken', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.MyToken>
deployContract(name: 'TokenCaller', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.TokenCaller>

  deployContract(name: 'MyToken', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.MyToken>
deployContract(name: 'TokenCaller', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.TokenCaller>
